    ...
    <div className="fixed bottom-6 left-6 z-40 flex flex-col items-center gap-3">
      ...
      {showScrollTop && (
        <button
          ...
          className="flex h-11 w-11 items-center justify-center rounded-full border border-white/20 bg-card/80 text-foreground shadow-lg backdrop-blur-xl transition-all duration-300 hover:-translate-y-1 hover:border-primary hover:bg-primary hover:text-primary-foreground cursor-pointer animate-in fade-in zoom-in"
        >
      ...
      <a
        ...
        className="group relative flex h-13 w-13 items-center justify-center rounded-full bg-emerald-500 text-white shadow-[0_8px_25px_rgba(16,185,129,0.4)] transition-all duration-300 hover:scale-110 hover:bg-emerald-400 active:scale-95 cursor-pointer"
      >
