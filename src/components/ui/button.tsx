  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium cursor-pointer transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background disabled:pointer-events-none disabled:opacity-50 disabled:cursor-not-allowed active:translate-y-px [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        hero: "bg-primary text-primary-foreground shadow-cta hover:-translate-y-0.5 hover:bg-primary-highlight hover:shadow-cta-hover",
        heroOutline:
          "border border-foreground/20 bg-foreground/5 text-foreground backdrop-blur-sm hover:-translate-y-0.5 hover:border-primary/60 hover:bg-primary/10",
      },
      size: {
        ...
        icon: "h-9 w-9",
        hero: "h-13 px-7 text-base sm:h-14 sm:px-9",
      },
    },
    defaultVariants: {
      variant: "default",
