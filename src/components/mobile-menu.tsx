        ...
        <div className="mt-10 relative">
          ...
          <SheetClose asChild>
            <Button
              ...
              variant="hero"
              size="hero"
              className="group relative w-full overflow-hidden text-lg shadow-lg shadow-primary/25 transition-all duration-300 hover:shadow-primary/30 active:scale-[0.98]"
            >
              <a href="#contact">
                ...
                <span className="transition-transform duration-300 group-hover:scale-[1.02] inline-block">
                  اطلب موقعك الآن
                </span>
              </a>
            </Button>
