...
import { Check, ShieldCheck, Zap, Globe, Layout, Smartphone, Search, RefreshCw, Lock, FastForward } from "lucide-react";

const featureIcons = { Check, ShieldCheck, Zap, Globe, Layout, Smartphone, Search, RefreshCw, Lock, FastForward };

export function FeaturesSection() {
  return (
    <section id="features" aria-labelledby="features-title" className="relative z-10 bg-background/50 py-12 sm:py-16 border-t border-border/20">
