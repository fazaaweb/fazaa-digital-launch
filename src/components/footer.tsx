...
export function Footer() {
  ...
  return (
    <footer className="relative z-10 border-t border-white/10 bg-card/90 backdrop-blur-2xl text-foreground">
      {/* Top Banner */}
      <div className="border-b border-white/5 bg-gradient-to-r from-primary/10 via-card/50 to-primary/5 py-8 px-4 sm:px-6 lg:px-8">
        <div className="mx-auto flex max-w-7xl flex-col items-center justify-between gap-4 text-center md:flex-row md:text-right">
          ...
          <a
            ...
            className="inline-flex items-center gap-2 rounded-xl bg-primary px-6 py-3 text-xs font-bold text-primary-foreground shadow-cta transition-all hover:bg-primary-highlight hover:shadow-cta-hover cursor-pointer"
          >
      ...
      <div className="mx-auto max-w-7xl py-16 px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 gap-10 md:grid-cols-2 lg:grid-cols-5">
          ...
          <div>
            ...
            <ul className="mt-4 space-y-3 text-xs sm:text-sm text-secondary-foreground/80">
              <li className="flex items-center gap-2">
                <MessageSquare className="h-4 w-4 text-emerald-400 shrink-0" />
                <span>واتساب: +967 777 000 000</span>
              </li>
              <li className="flex items-center gap-2">
                <Mail className="h-4 w-4 text-primary-highlight shrink-0" />
        ...
        <div className="mt-14 flex flex-col items-center justify-between gap-4 border-t border-white/10 pt-8 text-xs text-muted-foreground sm:flex-row">
          ...
          <div className="flex items-center gap-4">
            <button
              onClick={scrollToTop}
              className="flex items-center gap-1.5 text-primary-highlight transition-colors hover:text-foreground cursor-pointer"
            >
