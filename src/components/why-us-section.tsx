import { Check, Flame, Gauge, Lock, Sparkles, X, Zap } from "lucide-react";
    ...
    <section id="why-us" className="relative z-10 py-24 px-4 sm:px-6 lg:px-8">
      ...
      <div className="mx-auto max-w-7xl">
        ...
        <div className="mt-14 grid grid-cols-1 gap-6 md:grid-cols-2">
          ...
          {/* Traditional Card */}
          <div className="relative overflow-hidden rounded-3xl border border-white/10 bg-card/40 p-8 backdrop-blur-xl opacity-80">
            <div className="flex items-center justify-between">
              <div>
        ...
        <div className="mt-12 overflow-hidden rounded-3xl border border-white/10 bg-card/60 backdrop-blur-xl shadow-xl">
          <div className="overflow-x-auto">
            <table className="w-full text-right border-collapse">
              <thead>
                <tr className="border-b border-white/10 bg-secondary/50 text-xs sm:text-sm font-bold text-foreground">
                  <th className="p-4 sm:p-5">المعيار الهندسي والتجاري</th>
                  <th className="p-4 sm:p-5 text-primary-highlight bg-primary/10">منصات فزعة ويب المخصصة</th>
                  <th className="p-4 sm:p-5 text-muted-foreground">المواقع والقوالب التقليدية</th>
                </tr>
              </thead>
              <tbody className="divide-y divide-white/5 text-xs sm:text-sm">
                {comparisons.map((row, idx) => (
                  <tr key={idx} className="transition-colors hover:bg-white/5">
                    ...
                    <td className="p-4 sm:p-5 bg-primary/5 text-secondary-foreground font-medium">
