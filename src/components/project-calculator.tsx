...
أرجو تزويدي بعرض سعر تفصيلي وبدء التنسيق. شكراً لكم!`;
  ...
  return (
    <section className="relative z-10 bg-gradient-to-b from-background via-card/30 to-background py-24 px-4 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-7xl">
        ...
        <div className="mt-16 grid grid-cols-1 gap-8 lg:grid-cols-12">
          ...
          {/* Live Estimation Summary (4 Cols) */}
          <div className="lg:col-span-4">
            <div className="sticky top-28 rounded-3xl border border-primary/40 bg-card/80 p-6 shadow-[0_20px_50px_rgba(0,0,0,0.4)] backdrop-blur-2xl">
              <div className="flex items-center justify-between border-b border-white/10 pb-4">
                <span className="text-sm font-bold text-foreground">ملخص التهيأة المباشرة</span>
                <span className="rounded-full border border-emerald-500/30 bg-emerald-500/20 px-2.5 py-0.5 text-xs font-bold text-emerald-400">
                  حساب فوري
                </span>
              </div>
              ...
              <div className="mt-5 space-y-3.5 text-xs text-secondary-foreground/90">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <span className="font-bold text-foreground">React 19 + Clean Architecture</span>
                </div>
              ...
              <div className="mt-6 rounded-2xl border border-primary/30 bg-gradient-to-br from-primary/15 to-transparent p-4">
                ...
                <p className="mt-1 text-[0.6875rem] leading-normal text-muted-foreground">
