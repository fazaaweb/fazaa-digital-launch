...
const projects: Project[] = [
  {
    ...
    techStack: ["React 19", "Tailwind CSS", "Apple Pay", "Cloud DB"],
  ...
  },
  {
    ...
    techStack: ["React 19", "Interactive Maps", "TypeScript", "Tailwind"],
  ...
  },
  {
    ...
    techStack: ["React 19", "WhatsApp API", "Calendar API", "Zod"],
  ...
  },
  {
    ...
    techStack: ["React 19", "QR Code Engine", "Mada Payment", "Tailwind"],
  ...
  },
  {
    ...
    techStack: ["React 19", "Video Engine", "PDF Generator", "TypeScript"],
        ...
        <div className="mt-12 flex flex-wrap items-center justify-center gap-2 sm:gap-3">
          {categories.map((cat) => (
            <button
              ...
              className={`cursor-pointer rounded-full px-5 py-2 text-xs font-bold transition-all duration-200 sm:text-sm ${
        ...
        <div className="mt-14 grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
          {filteredProjects.map((project) => (
            ...
            >
              ...
              <div
                className={`relative flex h-60 w-full flex-col justify-between overflow-hidden border-b border-white/10 bg-gradient-to-b ${project.gradient} p-6`}
              >
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-1 rounded-full border border-emerald-500/30 bg-emerald-500/20 px-2.5 py-1 text-[0.6875rem] font-bold text-emerald-400">
                ...
                <div className="mx-auto w-full max-w-[85%] transform rounded-t-xl border border-white/15 bg-black/60 p-3 shadow-2xl backdrop-blur-lg transition-transform duration-500 group-hover:scale-105">
                  ...
                  <div className="mt-3 space-y-2">
                    <div className="h-3 w-3/4 animate-pulse rounded bg-primary/40" />
              ...
              <div className="flex flex-1 flex-col justify-between p-6">
                <div>
                  ...
                  <h3 className="mt-1 text-lg font-bold text-foreground transition-colors group-hover:text-primary-highlight sm:text-xl">
                    {project.title}
                  </h3>
                ...
                <div className="mt-6 border-t border-white/10 pt-4">
                  <div className="mb-4 flex flex-wrap gap-1.5">
                    {project.techStack.map((tech, i) => (
                      <span
                        key={i}
                        className="rounded-md border border-white/5 bg-background/60 px-2 py-0.5 font-mono text-[0.6875rem] font-medium text-muted-foreground"
                      >
                        {tech}
                      </span>
                    ))}
                  ...
                  <Dialog>
                    <DialogTrigger asChild>
                      <Button
                        variant="heroOutline"
                        className="w-full cursor-pointer justify-center gap-2 text-xs font-bold"
                        ...
                        <div>
                          ...
                          <ul className="mt-2 space-y-2">
                            {project.deliverables.map((item, idx) => (
                              <li key={idx} className="flex items-center gap-2 text-xs text-secondary-foreground/90 sm:text-sm">
