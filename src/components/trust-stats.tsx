import { CheckCircle2, Cpu, Flame, Gauge, ShieldCheck, Sparkles, Trophy, Zap } from "lucide-react";
...
const industries = [
  ...
  "الشركات القابضة والمؤسسات",
  "الشركات التقنية وSaaS",
  "القطاع العقاري والهندسي",
  "المجمعات الطبية والاستشارات",
  "المطاعم والضيافة الراقية",
];

export function TrustStats() {
  return (
    <section className="relative z-10 -mt-8 px-4 pb-20 sm:-mt-12 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-7xl">
              ...
              >
                ...
                <div className="relative z-10 flex flex-col justify-between h-full">
                  ...
                  <div className="mt-5">
                    ...
                    <p className="mt-1 text-xs leading-relaxed text-muted-foreground sm:text-xs">
                      {stat.detail}
                    </p>
                  </div>
                </div>
        ...
        <div className="mt-10 overflow-hidden rounded-2xl border border-white/10 bg-secondary/30 p-4 backdrop-blur-md">
          <div className="flex flex-col items-center justify-between gap-4 md:flex-row">
            <div className="flex items-center gap-2 text-xs font-bold text-foreground/90 whitespace-nowrap">
