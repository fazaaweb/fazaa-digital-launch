    ...
    <div className="hero-reveal hero-delay-3 relative z-[11] flex w-full flex-col items-center gap-2.5 sm:w-auto sm:flex-row sm:justify-center sm:gap-3">
      <div className="relative w-full sm:w-auto animate-pulse-scale">
        ...
        <Button
          ...
          variant="hero"
          size="hero"
          className="group relative w-full overflow-hidden shadow-lg shadow-primary/25 transition-all duration-300 hover:shadow-primary/30 active:scale-[0.98] sm:w-auto"
        >
          <a href="#contact">
      ...
      <Button
        ...
        variant="heroOutline"
        size="hero"
        className="w-full sm:w-auto border-2 border-primary/60 text-white hover:bg-primary/20 hover:border-primary hover:text-white shadow-[0_0_15px_rgba(0,0,0,0.5)]"
      >
