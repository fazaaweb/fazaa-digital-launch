  ...
  return (
    <section id="process" className="relative z-10 py-24 px-4 sm:px-6 lg:px-8">
      ...
      <div className="mx-auto max-w-7xl">
            ...
            return (
              <div
                ...
                className={`group relative flex cursor-pointer flex-col justify-between overflow-hidden rounded-3xl border p-6 transition-all duration-300 ${
                  isActive
                    ? "border-primary bg-primary/15 shadow-[0_16px_35px_rgba(59,130,246,0.2)] scale-[1.02]"
              ...
              >
                ...
                {/* Step Content */}
                <div className="mt-6">
                  <div className="text-xs font-semibold text-primary-highlight font-mono">
                    {step.duration}
                  </div>
                ...
                <div className="mt-4 pt-3 border-t border-white/10 text-right">
                  <span className="text-[0.6875rem] font-bold text-primary-highlight inline-flex items-center gap-1">
        ...
        <div className="mt-8 rounded-3xl border border-primary/30 bg-card/80 p-8 sm:p-10 backdrop-blur-2xl shadow-2xl">
          <div className="grid grid-cols-1 gap-8 lg:grid-cols-12 lg:items-center">
            <div className="lg:col-span-8">
              <div className="flex items-center gap-3">
                <span className="rounded-full bg-primary/20 px-3 py-1 text-xs font-bold text-primary-highlight border border-primary/30">
              ...
              <div className="mt-6">
                ...
                <div className="mt-3 grid grid-cols-1 gap-2.5 sm:grid-cols-2">
                  {steps[activeStep].deliverables.map((item, i) => (
                    <div
                      key={i}
                      className="flex items-center gap-2 rounded-xl border border-white/5 bg-background/50 p-3 text-xs sm:text-sm text-foreground/90"
                    >
