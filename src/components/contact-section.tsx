    ...
    <section id="contact" className="relative z-10 py-24 px-4 sm:px-6 lg:px-8">
      ...
      <div className="mx-auto max-w-7xl">
        ...
        <div className="mt-16 grid grid-cols-1 gap-8 lg:grid-cols-12">
          ...
          <div className="flex flex-col justify-between space-y-8 rounded-3xl border border-white/10 bg-card/60 p-8 shadow-xl backdrop-blur-2xl sm:p-10 lg:col-span-5">
            <div>
            ...
            <div className="border-t border-white/10 pt-6">
              <div className="grid grid-cols-2 gap-3 text-xs text-muted-foreground">
                <div className="flex items-center gap-2">
                  <ShieldCheck className="h-4 w-4 shrink-0 text-primary-highlight" />
          ...
          <div className="rounded-3xl border border-primary/30 bg-card/80 p-8 shadow-2xl backdrop-blur-2xl sm:p-10 lg:col-span-7">
            ...
            {submitted ? (
              <div className="mt-8 rounded-2xl border border-emerald-500/30 bg-emerald-500/10 p-6 text-center">
                ...
                <p className="mt-2 text-xs text-secondary-foreground sm:text-sm">
              ...
              <form onSubmit={handleSubmit} className="mt-8 space-y-5">
                ...
                <div className="space-y-2 text-right">
                  ...
                  <select
                    ...
                    className="w-full rounded-md border border-white/15 bg-background/60 px-3 py-2 text-xs text-foreground focus:ring-2 focus:ring-primary focus:outline-none sm:text-sm"
                  >
