...
const services: Service[] = [
  {
    ...
    description:
      "نبني مواقع ومنصات رقمية متقدمة من الصفر بأحدث تقنيات الويب الحديثة (React 19، TypeScript، Tailwind) لتقديم سرعة خارقة، كود نظيف، وحماية لا تُخترق.",
    icon: Code2,
    badge: "الأكثر طلبًا",
    features: [
  ...
  },
  {
    ...
    techStack: ["Apple Pay", "Mada / Visa", "WhatsApp API", "Cloud DB"],
  ...
  },
  {
    ...
    features: [
      ...
      "ربط متكامل مع إحصائيات قوقل (Google Analytics 4)",
    ],
  ...
  },
  {
    ...
    techStack: ["Cloudflare Edge", "AWS / Global CDN", "Daily Auto-Backup", "SSL TLS 1.3"],
  ...
  return (
    <section id="services" className="relative z-10 py-24 px-4 sm:px-6 lg:px-8">
      ...
      <div className="mx-auto max-w-7xl">
          ...
          {services.map((service) => {
            ...
            return (
              ...
              >
                {/* Radial Glow */}
                <div
                  className={`pointer-events-none absolute -right-20 -top-20 h-56 w-56 rounded-full bg-gradient-to-br ${service.color} blur-3xl opacity-60 transition-opacity duration-500 group-hover:opacity-100`}
                />
                ...
                <div className="relative z-10">
                  ...
                  <div className="mt-6">
                    ...
                    <div className="mt-1 font-mono text-xs font-semibold tracking-wider text-muted-foreground uppercase">
                      {service.subtitle}
                    </div>
                ...
                <div className="relative z-10 mt-8 border-t border-white/10 pt-5">
                  ...
                  <div className="mt-3 flex flex-wrap gap-1.5">
                    {service.techStack.map((tech, i) => (
                      <span
                        key={i}
                        className="rounded-md border border-white/5 bg-background/50 px-2 py-0.5 font-mono text-[0.6875rem] font-medium text-muted-foreground"
                      >
                        {tech}
                      </span>
                    ))}
        ...
        {/* Bottom CTA Banner */}
        <div className="mt-16 rounded-3xl border border-primary/30 bg-gradient-to-r from-primary/20 via-card/80 to-primary/10 p-8 text-center backdrop-blur-xl sm:p-10 md:flex md:items-center md:justify-between md:text-right">
