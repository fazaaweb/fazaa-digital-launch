          ...
          {testimonials.map((item, idx) => (
            ...
            >
              ...
              <div className="mt-6 border-t border-white/10 pt-4">
                <div className="rounded-xl border border-emerald-500/20 bg-emerald-500/10 px-3 py-1.5 text-[0.6875rem] font-bold text-emerald-400 flex items-center gap-1.5">
                ...
                <div className="mt-3">
                  ...
                  <div className="text-[0.6875rem] text-primary-highlight font-semibold">
                    {item.role} • {item.company}
                  </div>
                  <div className="mt-0.5 text-[0.6875rem] text-muted-foreground font-medium">
